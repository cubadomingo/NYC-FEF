...
const Philosophy = () => (
  <div className="container" styleName="philosophy">
    ...
    <p>
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed congue, urna a convallis ullamcorper, ligula sem pulvinar arcu, tempor semp velit mi in magna. Mauris nec auctor odio. Donec ultrices lacus sed leo laoreet aliquam. Cras eu volutpat ante. Nulla aliquam volutpat felis, sed iaculis libero posuere a. Phasellus nec metus eu ligula fermentum accumsan. Nullam vehicula urna dolor, quis sagittis urna auctor at. Duis eget magna at erat hendrerit aliquam ut eu orci. Nullam sit amet sem molestie, dictum lectus sit amet, tempus mi. Sed faucibus bibendum maximus. Morbi ac dui sagittis, malesuada ex non, sagittis ex. Proin nec diam leo.
    </p>
    <p>
...
export default CSSModules(Philosophy, styles);
